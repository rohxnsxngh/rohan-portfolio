  ...
  <div>
    ...
    <div class="flex mt-4 cursor-pointer">
      ...
      <a class="mr-2 tablet:mr-8" href="https://github.com/rohxnsxngh">
        <svg class="animate-pulse w-8 tablet:w-16" viewBox="0 0 48 48" fill="#73D7FF">
      ...
      <a class="mr-2 tablet:mr-8" href="https://www.instagram.com/rohxnsxngh/">
        ...
        >
          ...
          />
          <path
            d="M157.588,48.38c44.505,5.729,31.443,70.219,30.205,101.478c-0.688,17.188-3.758,30.48-21.496,36.438   c-23.33,7.838-57.706,5.225-81.494,1.742c-15.905-2.292-28.372-7.059-32.772-23.559c-6.967-26.08-4.996-61.373-1.971-87.957   c0.092-0.504,0.229-0.871,0.458-1.192C50.93,35.547,134.441,45.401,157.588,48.38z"
          />
          <path
            stroke="#73D7FF"
            fill="#73D7FF"
          ...
          />
          <path
            d="M93.282,126.483c5.546,15.584,25.255,27.959,40.976,18.334c31.763-19.434-5.546-72.235-31.718-48.814   C93.282,101.457,89.661,116.261,93.282,126.483z"
          />
        </svg>
      </a>
    </div>
