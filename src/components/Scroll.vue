<template>
  ...
  <div
    ...
    x-init="init()"
    x-cloak
    class="fixed inline-flex items-center justify-center overflow-hidden rounded-full bottom-5 right-5"
  >
  ...
  <!-- Social links -->
  <div class="fixed flex flex-col items-center space-y-4 bottom-5 left-5">
    <a
