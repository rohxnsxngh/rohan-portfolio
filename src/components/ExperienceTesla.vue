<template>
  <div class="backdrop-blur-sm">
    ...
    <ul class="text-sm font-semibold tablet:text-xl font-semibold">
      ...
      <li>
        - Built REST API’s in .NET with C# for multiple CRUD applications.
      </li>
      <li>
        <strong class="text-sm text-regal-blue tablet:text-regal-blue text-2xl"
          >- </strong
      ...
      <p style="color: white">
        ...
        >
        .NET 4.7.2, Vue.js, PostgreSQL, Tailwind CSS, Three.js, Bootstrap,
        Express.js
      </p>
      <p class="float-right text-regal-blue my-6">Jan. 2022 - Sept. 2022</p>
    </ul>
  </div>
</template>
